            ...
            <main className={styles.dashboardMain}>
                <div className={styles.dashboardContent}>
                    ...
                    <div className={styles.statsGrid}>
                        ...
                        <div className={`${styles.statCard} ${styles.small}`}>
                            ...
                            <div className={styles.statContent}>
                                <div className={styles.statNumber}>{stats.noticiasRevisar}</div>
                                <div className={styles.statLabel}>Borradores de Noticias</div>
                            </div>
                        </div>
                    </div>
                </div>
